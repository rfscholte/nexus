    ...
    extends AbstractNexusIntegrationTest
{
        ...
        throws Exception
    {
        ...
        AssertJUnit.assertTrue( "Attribute files should be generated after rebuild", jar.exists() );
        File pom = new File( nexusWorkDir, attributePath + "artifact-1.0.0.pom" );
        AssertJUnit.assertTrue( "Attribute files should be generated after rebuild", pom.exists() );
