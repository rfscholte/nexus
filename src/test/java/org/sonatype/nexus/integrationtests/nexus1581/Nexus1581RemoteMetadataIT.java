    ...
    extends AbstractNexusProxyIntegrationTest
{
    ...
    @Test
    public void testGetRemoteMirrorList()
        throws IOException
    {
        ...
        AssertJUnit.assertEquals( proxyBaseURL + "/mirror-repo", mirrorIdMap.get( "mirror1" ) );

        AssertJUnit.assertTrue( mirrorIdMap.containsKey( "mirror2" ) );
        AssertJUnit.assertEquals( proxyBaseURL + "/void", mirrorIdMap.get( "mirror2" ) );
