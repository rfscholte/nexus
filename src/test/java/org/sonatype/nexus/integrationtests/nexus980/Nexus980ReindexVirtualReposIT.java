    ...
    extends AbstractNexusIntegrationTest
{
        ...
        throws IOException
    {
        ...
        AssertJUnit.assertFalse( "Should not being able to reindex a shadow repo", status.isSuccess() );
    }
        ...
        throws Exception
    {
        ...
        AssertJUnit.assertFalse( "Should not be able to create a reindex task to a virtual repo", status.isSuccess() );
    }
