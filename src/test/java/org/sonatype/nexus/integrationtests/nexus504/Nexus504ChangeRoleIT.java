    ...
    extends AbstractPrivilegeTest
{
        ...
        throws Exception
    {
        ...
        AssertJUnit.assertEquals( "User should not be able to login ", 403, status.getCode() );
        ...
        AssertJUnit.assertTrue( "Unable to add login privilege to role " + NEXUS504_ROLE + "\n"
        ...
        AssertJUnit.assertEquals( "User should be able to login ", 200, status.getCode() );
    }
}
