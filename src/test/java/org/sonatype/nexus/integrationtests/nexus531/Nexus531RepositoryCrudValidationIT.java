    ...
    extends AbstractPrivilegeTest
{
        ...
        throws IOException
    {
        ...
        {
            AssertJUnit.fail( "Repo should not have been created: " + response.getStatus() + "\n" + responseText );
        }
        ...
        throws IOException
    {
        ...
        AssertJUnit.assertTrue( "Expected RepoType to default: " + response.getStatus() + "\n" + responseText,
                           response.getStatus().isSuccess() );
        // change in functionality
        // AssertJUnit.assertFalse( "Expected failure: "+ response.getStatus()+"\n"+responseText,
        // response.getStatus().isSuccess() );
    }
        ...
        throws IOException
    {
        ...
        try
        {
            ...
            AssertJUnit.fail( "Expected to throw ConversionException" );
        }
        ...
        throws IOException
    {
        ...
        AssertJUnit.assertFalse( "Repo should not have been created: " + response.getStatus() + "\n" + responseText,
                            response.getStatus().isSuccess() );
        AssertJUnit.assertTrue( "Response text did not contain an error message. \nResponse Text:\n " + responseText,
                           responseText.contains( "<errors>" ) );
        ...
        throws IOException
    {
        ...
        AssertJUnit.assertTrue( "Expected name to default." + responseText, response.getStatus().isSuccess() );
        AssertJUnit.assertTrue( "Expected name to default to id",
        ...
        throws IOException
    {
        ...
        AssertJUnit.assertTrue( "Expected DefaultLocalStorageUrl to be ignored on create" + response.getStatus()
        ...
        throws IOException
    {
        ...
        if ( !this.printKnownErrorButDoNotFail( this.getClass(), "updateValidatioinTest" ) )
        {
            ...
            AssertJUnit.assertFalse( "Repo should not have been updated: " + response.getStatus() + "\n" + responseText,
                                response.getStatus().isSuccess() );
            AssertJUnit.assertTrue( "Response text did not contain an error message. Status: " + response.getStatus()
        ...
        throws IOException
    {
        ...
        AssertJUnit.assertFalse( "Repo should not have been updated: " + response.getStatus() + "\n" + responseText,
                            response.getStatus().isSuccess() );
        AssertJUnit.assertTrue( "Response text did not contain an error message. " + response.getStatus()
            + "\nResponse Text:\n " + responseText, responseText.contains( "<errors>" ) );
    }
