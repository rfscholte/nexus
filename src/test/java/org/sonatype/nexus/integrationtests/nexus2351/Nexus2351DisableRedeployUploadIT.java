    ...
    extends AbstractMavenNexusIT
{
        ...
        throws Exception
    {
        ...
        AssertJUnit.assertTrue( metadata.getVersioning().getVersions().contains( "1.0.0" ) );
        AssertJUnit.assertTrue( metadata.getVersioning().getVersions().contains( "1.0.1" ) );

        AssertJUnit.assertEquals( 2, metadata.getVersioning().getVersions().size() );
        ...
        throws Exception
    {
        ...
        metadata = this.downloadMetadataFromRepository( gav1, this.getTestRepositoryId() );
        AssertJUnit.assertEquals( firstDeployDate, this.getLastDeployTimeStamp( metadata ) );
