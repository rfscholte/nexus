    ...
    extends AbstractNexus1923
{
        ...
        throws Exception
    {
        ...
        AssertJUnit.assertTrue( getSecondHostedRepositoryIndex().exists() );
        AssertJUnit.assertTrue( getThirdHostedRepositoryIndex().exists() );
        AssertJUnit.assertTrue( getGroupIndex().exists() );
        ...
        AssertJUnit.assertTrue( getSecondHostedRepositoryIndex().exists() );
        AssertJUnit.assertFalse( getSecondHostedRepositoryIndexIncrement( "1" ).exists() );
        validateCurrentSecondHostedIncrementalCounter( 0 );

        AssertJUnit.assertTrue( getThirdHostedRepositoryIndex().exists() );
        AssertJUnit.assertFalse( getThirdHostedRepositoryIndexIncrement( "1" ).exists() );
        validateCurrentThirdHostedIncrementalCounter( 0 );

        AssertJUnit.assertTrue( getGroupIndex().exists() );
        AssertJUnit.assertTrue( getGroupIndexIncrement( "1" ).exists() );
        AssertJUnit.assertFalse( getGroupIndexIncrement( "2" ).exists() );
        ...
        AssertJUnit.assertTrue( getSecondHostedRepositoryIndex().exists() );
        AssertJUnit.assertTrue( getSecondHostedRepositoryIndexIncrement( "1" ).exists() );
        AssertJUnit.assertFalse( getSecondHostedRepositoryIndexIncrement( "2" ).exists() );
        ...
        AssertJUnit.assertTrue( getGroupIndex().exists() );
        AssertJUnit.assertTrue( getGroupIndexIncrement( "1" ).exists() );
        AssertJUnit.assertTrue( getGroupIndexIncrement( "2" ).exists() );
        AssertJUnit.assertFalse( getGroupIndexIncrement( "3" ).exists() );
        ...
        AssertJUnit.assertTrue( getThirdHostedRepositoryIndex().exists() );
        AssertJUnit.assertTrue( getThirdHostedRepositoryIndexIncrement( "1" ).exists() );
        AssertJUnit.assertFalse( getThirdHostedRepositoryIndexIncrement( "2" ).exists() );
        ...
        AssertJUnit.assertTrue( getGroupIndexIncrement( "1" ).exists() );
        AssertJUnit.assertTrue( getGroupIndexIncrement( "2" ).exists() );
        AssertJUnit.assertTrue( getGroupIndexIncrement( "3" ).exists() );
        AssertJUnit.assertFalse( getGroupIndexIncrement( "4" ).exists() );
        ...
        AssertJUnit.assertTrue( getGroupIndexIncrement( "2" ).exists() );
        AssertJUnit.assertTrue( getGroupIndexIncrement( "3" ).exists() );
        AssertJUnit.assertTrue( getGroupIndexIncrement( "4" ).exists() );
        AssertJUnit.assertFalse( getGroupIndexIncrement( "5" ).exists() );
