    ...
    extends AbstractPrivilegeTest
{
        ...
        throws Exception
    {
        ...
        AssertJUnit.assertEquals( 0, this.routeUtil.getList().size() );
    }
        ...
        throws Exception
    {
        ...
        AssertJUnit.assertEquals( 1, routes.size() );
        AssertJUnit.assertEquals( "public", routes.get( 0 ).getGroupId() );
    }
        ...
        throws Exception
    {
        ...
        AssertJUnit.assertEquals( Status.CLIENT_ERROR_FORBIDDEN, response.getStatus() );
    }
