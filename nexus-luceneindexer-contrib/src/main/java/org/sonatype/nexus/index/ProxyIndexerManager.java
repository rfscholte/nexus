...
/**
 * An {@link IndexerManager} that will delegate to the legacy Lucene Indexer ({@link org.sonatype.nexus.index.DefaultIndexerManager} in case that
 * there are no other indexer managers or to a composite indexer manager {@link org.sonatype.nexus.index.CompositeIndexerManager} in case that
