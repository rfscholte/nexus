...
Ext.extend(Ext.tree.UserTreeLoader, Ext.tree.SonatypeTreeLoader, {
      ...
      createNode : function(parentId, id, isRole) {
        ...
        {
          var priv = this.privDataStore.getAt(this.privDataStore.findBy(function(rec, recid) {
                return rec.id == id;
              }, this));
        ...
        if (attr.id)
        {
          ...
          return (isRole ? new Ext.tree.AsyncTreeNode(attr) : new Ext.tree.TreeNode(attr));
        }
        else
        {
          return null;
